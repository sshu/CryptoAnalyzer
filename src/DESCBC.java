...
public class DESCBC {
	...
	public DESCBC(String plaintext, String desType) throws NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException, NoSuchPaddingException {
	...
	{		
		Cipher cipherEncrypt = Cipher.getInstance(desType + "/CBC/PKCS5Padding");
		...
		iv = cipherEncrypt.getIV();
		
		long totalTime = endTime - startTime;
		encryptSecs = (double)totalTime / 1000000;
	}
	
	public void decrypt() throws IllegalBlockSizeException, BadPaddingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException
	{
		Cipher cipherDecrypt = Cipher.getInstance(desType + "/CBC/PKCS5Padding");
		
		cipherDecrypt.init(Cipher.DECRYPT_MODE, desKey, new IvParameterSpec(iv));
